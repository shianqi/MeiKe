 ...
 * 
 * @see com.imudges.meike.bean.Teacher
...
public class TeacherDAO extends BaseHibernateDAO {
	...
	public static final String OF_ORGANIZATION_ID = "ofOrganizationId";
	...
	public Teacher findById(java.lang.Integer id) {
		...
		try {
			Teacher instance = (Teacher) getSession().get(
					"com.imudges.meike.bean.Teacher", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Teacher instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.imudges.meike.bean.Teacher")
	...
	public List findByIsTutor(Object isTutor) {
		return findByProperty(IS_TUTOR, isTutor);
	}

	public List findByOfOrganizationId(Object ofOrganizationId) {
		return findByProperty(OF_ORGANIZATION_ID, ofOrganizationId);
	}
